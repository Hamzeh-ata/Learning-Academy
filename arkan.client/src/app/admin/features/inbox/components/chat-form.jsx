      ...
      <div className="flex w-full items-center">
        <div className="relative py-4 px-2 text-md flex-1">
          <input
            ...
            className="rounded-xl shadow-sm text-gray-200 focus:shadow-md px-4 py-3 bg-slate-800 focus:outline-none focus:bg-slate-700 w-full placeholder-gray-400"
          />
        ...
        <div className=" text-center rounded-full text-blue-grey-400/70 hover:text-blue-600 hover:border-blue-700   me-2">
          <DropZone
            onChange={(e) => {
