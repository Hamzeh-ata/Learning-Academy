  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        placeholder="Search..."
        className="rounded-2xl shadow-sm text-gray-600 focus:shadow-md px-8 py-3 bg-slate-100 focus:outline-none focus:bg-slate-200 w-full placeholder-gray-400"
      />
